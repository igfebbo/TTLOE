function plotClusterRastersAndPSTHs(clusterIdx, alignedSpikeMatrices, rateTables, stimuliParams, blockParams,TTL_struct, sampleRate, analysis_folder)
    ...
    for b = 1:nBlocks
        ...
        for t = 1:nAligns
            ...
            % shade stimuli
            [yHandles, yLabels] = shadeStimuli(stimuliParams, TTL_struct,blockParams(b).alignmentTTLs{t},blockParams(b).alignmentWindows{t}, n_trials);
